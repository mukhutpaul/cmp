...
//                 payload.getSeances().forEach(this::upsertSeance);
//                 payload.getSessions().forEach(this::upsertSession);
//                 payload.getControles().forEach(this::upsertControle);
//                 payload.getDocuments().forEach(this::saveDocument);
//         }
